    ...
    const web3Modal = new Web3Modal({
      ...
      providerOptions: {
        walletconnect: {
          ...
          options: {
            infuraId: "312e37d0eb3a48e7a6fcd3a074676396",
          },
        },
      },
    });
            ...
            account && (
              <>
                <Link href="/createAuction">
                  <a className={link}>Create Auction</a>
                </Link>
                <Link href="/createDeed">
                  <a className={link}>Create Deed</a>
                </Link>
              </>
            )
          }
